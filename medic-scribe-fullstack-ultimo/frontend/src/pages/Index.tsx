...
const Index = ({ theme, onToggleTheme }: IndexProps) => {
  ...
  const { setOnNoteSaved, setOnNewNoteReceived } = useSOAPNotes();
  ...
  useEffect(() => {
    ...
    // Configurar el callback para recibir nuevas notas vía WebSocket
  useEffect(() => {
    const callback = (content: string) => {
      setCurrentContent(content);
      // Limpiar la consulta seleccionada ya que esta es una nueva nota
